...
:set errorLogPath="F:\web-\log.txt"

:: MySQL EXE Path
:set mysqldumpexe="D:\MySQL\MySQL Server 5.6\bin\mysqldump.exe"

:: Error log path
:set backupfldr=\\ip\MySQLBackup\
set backupfldr=F:\Siva-docs

:: Path to data folder which may differ from install dir
:set datafldr="D:\MySQL\MySQL Server 5.6\data"
